...
if (!twinPackage.includes('wallThicknessReviewed') || !twinPackage.includes('wallJunctionsPrepared') || !twinPackage.includes('floorPlacementVerified') || !twinPackage.includes('slabGeometryPrepared') || !twinPackage.includes('openingCutsPrepared') || !twinPackage.includes('verticalCoreReviewed')) throw new Error('Twin handoff readiness is missing wall/junction/floor/slab/opening/core signals.');
if (!twinPackage.includes('wallJunctions') || !twinPackage.includes('slabGeometry') || !twinPackage.includes('verticalCoreNodes') || !twinPackage.includes('productionMeshReady: false')) throw new Error('Twin handoff junction/slab/core/safety payload is incomplete.');
...
console.log('DA:ON wall + junction + opening cut + slab geometry + vertical core + multi-floor building integrity: PASS');
