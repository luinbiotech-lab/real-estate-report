...
if (!database.includes('DATABASE_VERSION = 12') || !database.includes("'buildingReleaseSnapshots'") || !database.includes("'buildingReleaseSnapshotStates'") || !database.includes("'buildingReleaseShares'") || !database.includes("'buildingReleaseReviewNotes'") || !database.includes("'spaceRoomLinks'") || !database.includes("'roomRenovationAssessments'")) throw new Error('Release collaboration / interior room intelligence IndexedDB stores/version are incomplete.');
...
if (!releasePanel.includes('Building Release & Collaboration Layer') || !releasePanel.includes('Remote Viewer v2') || !releasePanel.includes('glTF v2') || !releasePanel.includes('IFC Writer Handoff') || !releasePanel.includes('External Share Foundation') || !releasePanel.includes('Review Comments')) throw new Error('Release collaboration UI is incomplete.');
...
console.log('DA:ON geometry mutation + release collaboration + remote viewer v2 + glTF/GLB v2 + BIM writer handoff integrity: PASS');