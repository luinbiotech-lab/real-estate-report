...
if (!database.includes('DATABASE_VERSION = 10') || !database.includes("'buildingReleaseSnapshots'") || !database.includes("'buildingReleaseSnapshotStates'") || !database.includes("'buildingReleaseShares'") || !database.includes("'buildingReleaseReviewNotes'")) throw new Error('Release collaboration IndexedDB stores/version are incomplete.');
