...
if (!database.includes('DATABASE_VERSION = 11') || !database.includes("'buildingReleaseSnapshots'") || !database.includes("'buildingReleaseSnapshotStates'") || !database.includes("'buildingReleaseShares'") || !database.includes("'buildingReleaseReviewNotes'") || !database.includes("'spaceRoomLinks'")) throw new Error('Release collaboration / interior room-link IndexedDB stores/version are incomplete.');
